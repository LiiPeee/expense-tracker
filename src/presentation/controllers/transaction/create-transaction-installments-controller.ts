...
import { ICreateTransactionUseCase } from "../../../domain/use-case/transaction/create-transaction-day-usecase";
import { BadRequestError } from "../../../infrastructure/errors/bad-request-error";
import { Controller } from "../../protocols/controller";
import { HttpResponse } from "../../protocols/http";
import { badRequest, created, serverError } from "../../response/helper";

export class CreateTransactionInstallMentsController implements Controller {
